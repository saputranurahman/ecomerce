  ...
  <div class="container mx-auto px-4">
    ...
    <div class="lg:col-gap-12 xl:col-gap-16 mt-8 grid grid-cols-1 gap-12 lg:mt-12 lg:grid-cols-5 lg:gap-16">
        ...
        <div class="lg:flex lg:items-start">
          <div class="lg:order-2 lg:ml-5">
            <div class="max-w-xl overflow-hidden rounded-lg">
              <img class="h-full w-full max-w-full object-cover" src="https://sneakers.id/images/products/553558-040/2_1672814156.jpg" alt="" />
            </div>
          </div>
          ...
          <div class="mt-2 w-full lg:order-1 lg:w-32 lg:flex-shrink-0">
            <div class="flex flex-row items-start lg:flex-col">
              <button type="button" class="flex-0 aspect-square mb-3 h-20 overflow-hidden rounded-lg border-2 border-gray-900 text-center">
                <img class="h-full w-full object-cover" src="https://sneakers.id/images/products/553558-040/2_1672814156.jpg    " alt="" />
              </button>
              <button type="button" class="flex-0 aspect-square mb-3 h-20 overflow-hidden rounded-lg border-2 border-transparent text-center">
                <img class="h-full w-full object-cover" src="https://sneakers.id/images/products/553558-040/7_1672814159.jpg" alt="" />
              </button>
              <button type="button" class="flex-0 aspect-square mb-3 h-20 overflow-hidden rounded-lg border-2 border-transparent text-center">
                <img class="h-full w-full object-cover" src="https://sneakers.id/images/products/553558-040/8_1672814159.jpg" alt="" />
              </button>
            </div>
          </div>
        </div>
      ...
      <div class="lg:col-span-2 lg:row-span-2 lg:row-end-2">
        <h1 class="sm: text-2xl font-bold text-gray-900 sm:text-3xl">AIR JORDAN 1 LOW SHADOW 3.0</h1>
        ...
        <div class="mt-3 flex select-none flex-wrap items-center gap-1">
          ...
          <label class="">
            ...
            <p class="peer-checked:bg-black peer-checked:text-white rounded-lg border border-black px-6 py-2 font-bold">41</p>
          </label>
          <label class="">
          ...
          <label class="">
            <input type="radio" name="type" value="Groud" class="peer sr-only" />
            <p class="peer-checked:bg-black peer-checked:text-white rounded-lg border border-black px-6 py-2 font-bold">44</p>
          </label>
        </div>

        <h2 class="mt-8 text-base text-gray-900">Pilihan Warna</h2>
        <div class="mt-3 flex select-none flex-wrap items-center gap-1">
          <label class="">
            <input type="radio" name="subscription" value="4 Months" class="peer sr-only" />
            <p class="peer-checked:bg-black peer-checked:text-white rounded-lg border border-black px-6 py-2 font-bold">Putih</p>
            
          </label>
          <label class="">
            <input type="radio" name="subscription" value="8 Months" class="peer sr-only" checked />
            <p class="peer-checked:bg-black peer-checked:text-white rounded-lg border border-black px-6 py-2 font-bold">Hitam</p>
            
          </label>
          <label class="">
            <input type="radio" name="subscription" value="12 Months" class="peer sr-only" />
            <p class="peer-checked:bg-black peer-checked:text-white rounded-lg border border-black px-6 py-2 font-bold">Biru</p>
        ...
        <div class="mt-10 flex flex-col items-center justify-between space-y-4 border-t border-b py-4 sm:flex-row sm:space-y-0">
          <div class="flex items-end">
            <h1 class="text-2xl font-bold">Rp3.399.000</h1>
      ...
      <div class="lg:col-span-3">
        ...
        <div class="mt-8 flow-root sm:mt-12">
          <h1 class="text-3xl font-bold">AIR JORDAN 1 LOW SHADOW 3.0</h1>
          <p class="mt-4">
            Terinspirasi oleh yang asli yang memulai debutnya pada tahun 1985, Air Jordan 1 Low menawarkan tampilan bersih dan klasik yang familier namun selalu segar. Dengan desain ikonik yang berpadu sempurna dengan setelan apa pun, sepatu ini memastikan Anda selalu tepat sasaran.
            Unit Air-Sole yang dienkapsulasi memberikan bantalan yang ringan. Kulit asli di bagian atas menawarkan daya tahan dan tampilan premium. Outsole karet padat meningkatkan traksi pada berbagai permukaan.
          </p>
          </div>
      </div>
    </div>
